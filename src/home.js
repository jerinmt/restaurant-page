...
const displayHome = function () {
    ...
    pic.src = image;
    intro.textContent = "Come taste and enjoy the dishes that you could get only in Kerala. Our restaurant brings you selected signature food from the Tropical Paradise.";
